...
function fa_admin_nav_active($page, $current) {
...
<aside class="fa-sidebar">
    ...
    <nav class="fa-sidebar-nav">
        <a href="dashboard.php" class="<?php echo fa_admin_nav_active('dashboard.php', $currentPage); ?>">
        ...
        <a href="students.php" class="<?php echo fa_admin_nav_active('students.php', $currentPage) ?: fa_admin_nav_active('student_view.php', $currentPage); ?>">
        ...
        <a href="courses.php" class="<?php echo fa_admin_nav_active('courses.php', $currentPage) ?: fa_admin_nav_active('edit_course.php', $currentPage); ?>">
        ...
        <a href="assignments.php" class="<?php echo fa_admin_nav_active('assignments.php', $currentPage); ?>">
        ...
        <a href="results.php" class="<?php echo fa_admin_nav_active('results.php', $currentPage); ?>">
